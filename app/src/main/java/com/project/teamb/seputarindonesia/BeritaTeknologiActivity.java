...
public class BeritaTeknologiActivity extends AppCompatActivity implements NewsAdapter.onSelectData {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(BeritaTeknologiActivity.this, "Gagal menampilkan data!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(BeritaTeknologiActivity.this, "Tidak ada jaringan internet!", Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void showNews() {
        newsAdapter = new NewsAdapter(BeritaTeknologiActivity.this, modelNews, this);
        rvTechno.setAdapter(newsAdapter);
    }

    @Override
    public void onSelected(ModelNews mdlNews) {
        startActivity(new Intent(BeritaTeknologiActivity.this, OpenNewsActivity.class).putExtra("url", mdlNews.getUrl()));
    }
}
